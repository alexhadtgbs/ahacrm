...
export async function GET() {
  const swaggerDocument = {
    openapi: '3.0.0',
    info: {
      title: 'ClínicaCRM API',
      description: 'API for managing ophthalmology clinic cases and patient leads. This API supports both session-based authentication (for browser requests) and API key authentication (for programmatic access).',
      version: '1.0.0',
      contact: {
        name: 'ClínicaCRM Support',
    ...
    paths: {
      '/api-keys': {
              ...
              'application/json': {
                schema: {
                  ...
                  properties: {
                    ...
                    keyType: {
                      type: 'string',
                      enum: ['secure', 'readable', 'prefixed'],
                      default: 'secure',
                      description: 'Type of API key to generate'
                    }
                  }
                }
              }
                ...
                'application/json': {
                  schema: {
                    ...
                    properties: {
                      ...
                      message: {
                        type: 'string',
                        example: 'API key created successfully. Please save this key securely - it will not be shown again.'
                      }
                    }
                  }
                }
        ...
        put: {
              ...
              'application/json': {
                schema: {
                  ...
                  properties: {
                    ...
                    expiresInDays: {
                      type: 'number',
                      description: 'Number of days until expiration (null to remove expiration)'
                    }
                  }
                }
              }
          ...
          responses: {
            ...
            '400': {
              description: 'Bad request - Missing API key ID',
              content: {
                'application/json': {
                  schema: {
                    type: 'object',
      ...
      '/cases': {
        get: {
          ...
          parameters: [
            ...
            },
            {
              ...
              schema: {
                type: 'string',
                enum: ['IN_CORSO', 'APPUNTAMENTO', 'CHIUSO']
              }
            },
            {
              name: 'channel',
              in: 'query',
              description: 'Filter by lead channel',
              schema: {
                type: 'string',
                enum: ['WEB', 'FACEBOOK', 'INFLUENCER']
              }
            },
            {
              name: 'date_from',
              in: 'query',
              description: 'Filter cases created from this date (ISO format)',
              schema: {
                type: 'string',
                format: 'date-time'
              }
            },
            {
              name: 'date_to',
              in: 'query',
              description: 'Filter cases created until this date (ISO format)',
              schema: {
                type: 'string',
                format: 'date-time'
              }
                ...
                'application/json': {
                  schema: {
                    ...
                    properties: {
                      ...
                      message: {
                        type: 'string',
                        example: 'Invalid or missing API key. Please provide a valid x-api-key header or Bearer token.'
                      }
                    }
                  }
                }
        ...
        post: {
          ...
          description: 'Create a new patient case/lead',
          security: [
            { ApiKeyAuth: [] },
            { BearerAuth: [] }
          ],
          requestBody: {
            ...
            content: {
              'application/json': {
                schema: {
                  type: 'object',
                  required: ['first_name', 'last_name', 'phone', 'channel', 'origin', 'clinic'],
                  properties: {
                    assigned_to: {
                      type: 'string',
                      format: 'uuid',
                      description: 'User ID assigned to this case'
                    },
                    first_name: {
                      type: 'string',
                    ...
                    origin: {
                      type: 'string',
                      description: 'Specific origin of the lead'
                    },
                    status: {
                      type: 'string',
                      enum: ['IN_CORSO', 'APPUNTAMENTO', 'CHIUSO'],
                    ...
                    outcome: {
                      type: 'string',
                      description: 'Current outcome or notes'
                    },
                    clinic: {
                      type: 'string',
                    ...
                    promotion: {
                      type: 'string',
                      description: 'Promotion or campaign'
                    },
                    follow_up_date: {
                      type: 'string',
                      format: 'date-time',
                    ...
                    dialer_campaign_tag: {
                      type: 'string',
                      description: 'Campaign tag for dialer integration'
                    }
                  }
                }
              }
        ...
        put: {
          summary: 'Update a case (full update)',
          description: 'Update all fields of an existing case',
          security: [
            { ApiKeyAuth: [] },
            { BearerAuth: [] }
          ],
        ...
        patch: {
          ...
          description: 'Update specific fields of an existing case',
          security: [
            { ApiKeyAuth: [] },
            { BearerAuth: [] }
          ],
    ...
    components: {
      securitySchemes: {
        ...
        BearerAuth: {
          type: 'http',
          scheme: 'bearer',
          description: 'Bearer token (alternative to x-api-key header)'
        }
      },
      schemas: {
        ApiKey: {
          ...
          properties: {
            ...
            key_preview: {
              type: 'string',
              description: 'Preview of the key hash (first and last few characters)'
            }
          },
          required: ['id', 'name', 'created_at', 'is_active', 'permissions', 'usage_count', 'key_preview']
        },
        Case: {
          type: 'object',
          properties: {
